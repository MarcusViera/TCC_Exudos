...
public class CameraController : MonoBehaviour {
	...
	public float camYAngle = 45.0f; // The camera x euler angle.
	public float camZAngle = 45.0f; // The camera x euler angle.
    ...
    //public Material material_Alfha ,material_Opaco;
	...
	void LateUpdate  () {
		...
		// Set camera angles.
		Quaternion rotation = Quaternion.Euler (camXAngle, camYAngle, camZAngle); 	
		...
		{		
			...
			if (Physics.Raycast(ray, out hit, maxDistance)) {
				...
				if(layersToTransparent.Contains(objectHit.gameObject.layer))
				{
					if(prevHit!=null)
					{
                        //prevHit.GetComponent<Renderer>().material = material_Opaco;
					...
					if(objectHit.GetComponent<Renderer>() != null)
					{
                        ...
                        prevHit.GetComponent<Renderer>().enabled = false;
                        //Troca de Material, Fazer a retroca.
                       // prevHit.GetComponent<Renderer>().material = material_Alfha; 
